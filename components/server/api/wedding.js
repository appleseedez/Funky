...
const weddingApi = {
  ...
  'get+/detailByResourceId/:resourceId': function*(next) {
    ...
    // 只取有用的字段
    this.model = this.model.pluck(
      "pcDetailImages","name","description","totalCost","originalPrice",
      "senceCost","hdpcCost","designConcept","theme","caseStyleName","color");
  ...
  'get+/followVideo/:position': function*(next) {
    ...
    // 只取有用的字段
    this.model = this.model.pluck("id","coverUrlWeb","name","updateTime");
  ...
  'get+/followVideo/detail/:id': function*(next) {
    ...
    // 只取有用的字段
    this.model = this.model.pluck("name","description","coverUrlWeb","videoUrl");
  ...
  'get+/f4/camera': function*(next) {
    ...
    // 只取有用的字段
    this.model = this.model.pluck("priceRemark","photoUrl","nickName","salePrice","description","workList");

...
const suppliesApi = {
  ...
  'get+/weddingsupplies/:position': function*(next) {
    ...
    // 只取有用的字段
    this.model = this.model.pluck("id","coverUrlWeb","title","sellingPrice","marketPrice");
  ...
  'get+/weddingsupplies/detail/:id': function*(next) {
    ...
    // 只取有用的字段
    this.model = this.model.pluck("pcDetailImages","title","description","parameter","content","sellingPrice","marketPrice");
